        ...
        <div class="row">
            <div class="col-md-4">
                <div class="profile-img">
                    <img style="width: -webkit-fill-available 1important;" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS52y5aInsxSm31CvHOFHWujqUx_wWTS9iM6s7BAm21oEN_RiGoog" alt=""/>
            ...
            <div class="col-md-2" v-if="isOwner && isLoggedIn">
                ...
                <div class="tab-content profile-tab" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p v-show="user.business_name">{{ user.business_name }}</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <p v-show="user.full_address">{{ user.full_address }}</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <p v-show="user.date_of_birth">{{ user.date_of_birth }}</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <p v-show="user.bvn_number">{{ user.bvn_number }}</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <p v-show="user.nin_number">{{ user.nin_number }}</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
